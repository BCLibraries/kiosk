var Campus = ( function() {
		var pub = {},
			...
			pathDisplayed,
			paths = { 
				Bapst : {  path : null, zoom : null, center : null	}, SWL : {  path : null, zoom : null, center : null	}, TML : {  path : null, zoom : null, center : null	}, SWL : {  path : null, zoom : null, center : null	}, ERC : {  path : null, zoom : null, center : null	}, Burns : {  path : null, zoom : null, center : null	}
			},
			labelText = new Array();
		...
		pub.initialize = function() {
			...
			/* Directions */
			$("#oneill").on("click", function() { pub.centerONeill(); $(this).css("color", "rgb(153, 0, 0)"); });
			$("#bapst").on("click", function() {  pub.showPath("Bapst"); clearDirectionColors(); $(this).css("color", "rgb(153, 0, 0)"); pathDisplayed = this.id; });
			$("#burns").on("click", function() { pub.showPath("Burns"); clearDirectionColors(); $(this).css("color", "rgb(153, 0, 0)"); pathDisplayed = this.id; });
			$("#swl").on("click", function() {  pub.showPath("SWL"); clearDirectionColors(); $(this).css("color", "rgb(153, 0, 0)"); pathDisplayed = this.id; });
			$("#tml").on("click", function() {  pub.showPath("TML"); clearDirectionColors(); $(this).css("color", "rgb(153, 0, 0)"); pathDisplayed = this.id; });
			$("#erc").on("click", function() {  pub.showPath("ERC"); clearDirectionColors();$(this).css("color", "rgb(153, 0, 0)"); pathDisplayed = this.id; });
			...
			$("#arrow_up").on("vmousedown", function() {
				var timeoutid = setInterval(function() { map.panBy(0, -panAmount) }, time);
			...
			$("#arrow_left").on("vmousedown", function() {
				var timeoutid = setInterval(function() { map.panBy(-panAmount, 0) }, time);
		...
		function markerNPaths() {
			/* Marker icons */
			var libraryMarker, libraryIconPath = "Images/CampusMap/marker_lib.png", herePath = "Images/CampusMap/marker_here.png";
