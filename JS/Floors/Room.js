var Room = (function() {
	...
	function initializeList() {
		...
		function popUps() {
			var toggleID;
				...
				$("[id^=Floor]").find("#rooms").children("[id^=room], #ref-desk, #circ-desk").on("click", function() {
					...
					/* Notes */
					//d3.select("#" + popUpID).append("p")
						//				  	.html("<strong>Notes: </strong>Projector, 10 desks, smells nice, bathroom adjacent.")				  
		...
		function turnOffPopUp(toggleID) {
			...
			setTimeout(function() {d3.select("#" + popUpID).remove()}, .25 * 1000);
		}
